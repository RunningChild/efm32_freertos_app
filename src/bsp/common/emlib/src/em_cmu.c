...
/***************************************************************************//**
 * @brief cmu_LFRCO_clockout _by_pbh_add
 ******************************************************************************/
void cmu_LFRCO_clockout(void)
{
    CMU->CTRL = (CMU->CTRL & ~_CMU_CTRL_CLKOUTSEL1_MASK)
                | _CMU_CTRL_CLKOUTSEL1_LFRCO;//_CMU_CTRL_CLKOUTSEL1_LFRCOQ

    CMU->ROUTE = (CMU->ROUTE & ~_CMU_ROUTE_LOCATION_MASK)
                | _CMU_ROUTE_LOCATION_LOC0;//PA1

    CMU->ROUTE = (CMU->ROUTE & ~_CMU_ROUTE_CLKOUT1PEN_MASK)
